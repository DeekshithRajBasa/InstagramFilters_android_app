...
import deekshithrajbasa.com.infilter.utils.BitmapUtils;
...
public class MainActivity extends AppCompatActivity implements FiltersListFragment.FiltersListFragmentListener, EditImageFragment.EditImageFragmentListener {
   ...
   public static final String IMAGE_NAME = "blabla.jpg";
    ...
    * */
    ...
    private void intothis(){
      final String IMAGE_NAME = "blabla.jpg";
        Bundle bundle=this.getIntent().getExtras();
        int pic=bundle.getInt("image");
        imagePreview.setImageResource(pic);
    }
}
